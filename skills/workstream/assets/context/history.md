...
| Task or milestone | Included tasks | Readiness | Lifecycle | Outcome | Delivery | closed_at | Evidence or recovery pointer |
| --- | --- | --- | --- | --- | --- | --- |
| {{task_or_milestone}} | {{included_task_ids}} | {{readiness}} | {{lifecycle}} | {{outcome}} | {{delivery}} | {{closed_at}} | {{evidence_or_recovery_pointer}} |
